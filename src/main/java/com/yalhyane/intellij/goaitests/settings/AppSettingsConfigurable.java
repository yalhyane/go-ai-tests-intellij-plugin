package com.yalhyane.intellij.goaitests.settings;

import com.intellij.openapi.options.Configurable;
import com.yalhyane.intellij.goaitests.GenerateAiTestsAction;
...
public class AppSettingsConfigurable implements Configurable {
    ...
    public void apply() {
        ...
        GenerateAiTestsAction.getInstance().reloadSettings();
    }
